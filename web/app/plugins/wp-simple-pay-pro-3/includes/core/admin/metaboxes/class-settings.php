...
class Settings {
	...
	private static function settings_tabs( $post ) {
		...
		$tabs = apply_filters(
			'simpay_form_settings_meta_tabs_li',
			array(
	...
	public static function save( $post_id, $post ) {
		...
		// Submit type.
		$checkout_submit_type = isset( $_POST['_checkout_submit_type'] ) ? sanitize_text_field( $_POST['_checkout_submit_type'] ) : 'pay';

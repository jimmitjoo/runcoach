...
<p>
<?php esc_html_e( 'Do you want to help us make WP Simple Pay even better? Enabling usage analytics helps us better determine new features and improvements to make. In turn, you get the most out of each and every update to WP Simple Pay.', 'simple-pay' ); ?>
</p>
...
echo wp_kses(
	sprintf(
		...
		esc_html__( 'Subscribe now and we will immediately send a %1$s10&#37; off%2$s discount code to your inbox. This code can be used to upgrade to any WP Simple Pay Pro license. No sensitive data is ever collected or stored. You may unsubscribe at anytime.', 'simple-pay' ),
		'<strong>',
		'</strong>'
	),
	array(
...
>
	<p>
		<label for="simpay-usage-tracking-email"><?php esc_html_e( 'First Name', 'simple-pay' ); ?></label><br />
	...
	<p>
		<button type="submit" name="submit" class="button button-primary"><?php esc_html_e( 'Yes, enable and send me the coupon!', 'simple-pay' ); ?></button>
